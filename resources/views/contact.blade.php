        ...
        <div class="container">
            ...
            <div class="contact-methods">
                <div class="contact-method">
                    <a href="mailto:nyl.sauval@laposte.net" class="contact-link">
                ...
                <div class="contact-method">
                    <a href="https://www.linkedin.com/in/nyl-sauval/" target="_blank" class="contact-link">
                        <div class="contact-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="contact-method">
                    <a href="https://gitlab.univ-artois.fr/nyl_sauval" target="_blank" class="contact-link">
                        <div class="contact-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
